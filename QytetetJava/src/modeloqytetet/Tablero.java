...
public class Tablero {
    ...
    */
    ...
    private void inicializar(){
        ...
        casillas.add (new Casilla (0, TipoCasilla.SALIDA, 0));
        ...
        casillas.add (new Casilla (4, TipoCasilla.PARKING, 0));
        ...
        casillas.add (new Casilla (12, TipoCasilla.JUEZ, 0));
        casillas.add (new Casilla (13, new TituloPropiedad ("Ieronimus", 800,
                85, (float)1.7, 700, 500)));
        casillas.add (new Casilla (14, TipoCasilla.SORPRESA, 0));
        ...
        casillas.add (new Casilla (17, TipoCasilla.IMPUESTO, 500));
        casillas.add (new Casilla (18, TipoCasilla.SORPRESA, 0));
